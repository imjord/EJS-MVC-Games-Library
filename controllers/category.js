...
const Categories = {
    ...
    getMusic(req,res) {
        const response =  fetch("https://api.igdb.com/v4/games", {
            ...
            body: 'fields name, cover.url; where genres = (7) & cover != null; limit 20;'
        }).then(response => response.json())
        .then(data => {
    ...
    getFighting(req,res) {
        const response =  fetch("https://api.igdb.com/v4/games", {
            ...
            body: 'fields name, cover.*; where genres = (4) & cover != null; limit 20;'
     ...
     getPlatform (req,res) {
        const response =   fetch("https://api.igdb.com/v4/games", {
            ...
            body: 'fields name, cover.*; where genres = (8) & cover != null; limit 20;'
        }).then(response => response.json()).then(data => {
    ...
    getPuzzle (req,res)  {
        const response =  fetch("https://api.igdb.com/v4/games", {
            ...
            body: 'fields name, cover.*; where genres = (9) & cover != null; limit 20;'
        }).then(response => response.json()).then(data => {
    ...
    const response =  fetch("https://api.igdb.com/v4/games", {
        ...
        body: 'fields name, cover.*; where genres = (10) & cover != null; limit 20;'
    }).then(response => response.json()).then(data => {
...
getRpg (req,res) {
    const response =  fetch("https://api.igdb.com/v4/games", {
        ...
        body: 'fields name, cover.*; where genres = (12) & cover != null; limit 20;'
    }).then(response => response.json()).then(data => {
...
getRts(req,res)  {
    const response =  fetch("https://api.igdb.com/v4/games", {
        ...
        body: 'fields name, cover.*; where genres = (11) & cover != null; limit 20;'
    }).then(response => response.json()).then(data => {
 ...
 getShooter (req,res) {
    const response =   fetch("https://api.igdb.com/v4/games", {
        ...
        body: 'fields name, cover.*; where genres = (5) & cover != null; limit 20;'
    }).then(response => response.json()).then(data => {
...
getSim  (req,res)  {
    const response =  fetch("https://api.igdb.com/v4/games", {
        ...
        body: 'fields name, cover.*; where genres = (13) & cover != null; limit 20;'
    }).then(response => response.json()).then(data => {
...
getSport (req,res)  {
    const response =  fetch("https://api.igdb.com/v4/games", {
        ...
        body: 'fields name, cover.*; where genres = (14) & cover != null; limit 20;'
    }).then(response => response.json()).then(data => {
